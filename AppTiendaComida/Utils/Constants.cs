...
namespace AppTiendaComida.Utils
{
    public static class Constants
    {
        public static string AppName = "ComidaFast";
        public static string ApiUrl = "https://localhost:7042/api/";
        public static string ApiUrlProductos = ApiUrl + "productos";
        public static string ApiUrlUsuarios = ApiUrl + "usuarios";
        public static string ApiUrlLogin = ApiUrl + "login";
        public static string ApiUrlRegistro = ApiUrl + "registro";
        public static string ApiUrlCarrito = ApiUrl + "carrito";
